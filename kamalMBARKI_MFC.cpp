...
// kamalMBARKI_MFC.cpp : définit les comportements de classe de l'application.
//
...
BEGIN_MESSAGE_MAP(CkamalMBARKIMFCApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construction de CkamalMBARKIMFCApp

CkamalMBARKIMFCApp::CkamalMBARKIMFCApp()
{
...
// Le seul et unique objet CkamalMBARKIMFCApp

CkamalMBARKIMFCApp theApp;


// Initialisation de CkamalMBARKIMFCApp

BOOL CkamalMBARKIMFCApp::InitInstance()
{
